...
# python run.py model=xfg_cross_rec encoder.transformer.num_layers=1 decoder.transformer.num_layers=1 project="xfg-temp" seed=44 proj_dim=785 # Visual token length
rm -rf outputs